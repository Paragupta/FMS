...
public class DataInitializationService {
	...
	public void initializeData() {
		...
		airportRepository.saveAll(Arrays.asList(jfk, lax, ord, dfw, sfo));
		...
		scheduledFlightRepository.saveAll(Arrays.asList(scheduledFlight1, scheduledFlight2, scheduledFlight3,
				scheduledFlight4, scheduledFlight5));
